...
namespace SchoolMVC.Controllers
{
    ...
    {
        private readonly DataaseContext _context;

        public EnrollmentsController(DataaseContext context)
        {
            _context = context;
        }
        ...
        {
            var dataaseContext = _context.Enrollments.Include(e => e.Course).Include(e => e.Student);
            return View(await dataaseContext.ToListAsync());
        }
